...
public class CruddemoApplication {
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		Course tempCourse = new Course("Learn java with pepe");

		tempCourse.addStudent(new Student("Pedro", "Rojas", "pedro@gmail.com"));
		tempCourse.addStudent(new Student("pepe", "Rojas", "pepe@gmail.com"));
		tempCourse.addStudent(new Student("Alberto", "Valladares", "alberto@gmail.com"));
